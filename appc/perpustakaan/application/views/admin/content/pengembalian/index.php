    ...
    <div class="content-area p-y-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="m-b-1">Pengembalian</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-group">
                                        <a href="<?php echo base_url(); ?>pengembalian/terima_pengembalian/<?= $p['id'] ?>" class="btn btn-sm btn-success">Konfirmasi</a>
                                        <!-- <a href="" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo $p['id']; ?>" class="btn btn-danger btn-sm">
                                            <font color="white">Tolak Peminjaman</font>
                                        </a> -->
